...
namespace nest
{
RecordablesMap< step_rate_generator >
  step_rate_generator::recordablesMap_;
...
{
  const step_rate_generator& pr =
    downcast< step_rate_generator >( proto );
